...
export default function Small() {
  return (
    <div className='bg-[#FFFFFF] w-[274px] h-[240px] ml-[23px] mt-[289px] rounded-[85px] position: relative'>

      <div className="flex flex-col ...">
        <div className='border-[#D5D5EB] border-[1px] w-[85px] h-[43px] rounded-[64px]  ml-[39px] mt-[40px] flex items-center justify-center font-weight-[500] font-size-[16px] paddding-[16px] '>
